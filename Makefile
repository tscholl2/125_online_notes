...
build/epub/output.epub: build/epub/intermediate.epub MathJax $(javascript) utils/post-process-epub.py
	python utils/post-process-epub.py --output=$@ --input=$< --mathjax=MathJax $(javascript)
